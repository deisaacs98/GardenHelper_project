...
class Species:
    ...
    def gardener_decoder(obj):
        return Species(obj['_id'], obj['common_name'],obj['_scientific_name'], obj['_status'],  obj['_rank'],
                        obj['_family_common_name'], obj['_family'], obj['_genus_id'],  obj['_genus'],
                        obj['_edible_part'], obj['_edible'], obj['_vegetable'], obj['_observations'])
